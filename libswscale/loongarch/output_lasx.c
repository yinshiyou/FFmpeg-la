                        ...
                        int y, enum AVPixelFormat target, int hasAlpha)
{
    ...
    for (i = 0; i < len; i += 16) {
        ...
        for (j = 0; j < chrFilterSize; j++) {
            ...
            u     = __lasx_xvmaddwl_w_h(u, temp, u_src);
            v     = __lasx_xvmaddwl_w_h(v, temp, v_src);
        }
                        ...
                        int hasAlpha)
{
    ...
    if (uvalpha < 2048) {
        ...
        for (i = 0; i < len; i += 16) {
            ...
            u     = __lasx_xvaddwl_w_h(src_u, bias_64);
        ...
        for (i = 0; i < len; i += 16) {
            ...
            y_l    = __lasx_xvaddwl_w_h(src_y, bias_64);
            y_h    = __lasx_xvaddwh_w_h(src_y, bias_64);
            u      = __lasx_xvaddwl_w_h(src_u0, src_u1);
            v      = __lasx_xvaddwl_w_h(src_v0, src_v1);
                             ...
                             int dstW, int y, enum AVPixelFormat target, int hasAlpha)
{
    ...
    for (i = 0; i < len; i += 16) {
        ...
        for (j = 0; j < chrFilterSize; j++) {
            ...
            u_l   = __lasx_xvmaddwl_w_h(u_l, u_src, temp);
            u_h   = __lasx_xvmaddwh_w_h(u_h, u_src, temp);
            v_l   = __lasx_xvmaddwl_w_h(v_l, v_src, temp);
            v_h   = __lasx_xvmaddwh_w_h(v_h, v_src, temp);
        }
                             ...
                             int hasAlpha)
{
    ...
    if (uvalpha < 2048) {
        ...
        for (i = 0; i < len; i += 16) {
            ...
            u_l = __lasx_xvaddwl_w_h(ub0, ub1);
            u_h = __lasx_xvaddwh_w_h(ub0, ub1);
            v_l = __lasx_xvaddwl_w_h(vb0, vb1);
            v_h = __lasx_xvaddwh_w_h(vb0, vb1);
            u_l = __lasx_xvsub_w(u_l, uv);
            u_h = __lasx_xvsub_w(u_h, uv);
            v_l = __lasx_xvsub_w(v_l, uv);
            v_h = __lasx_xvsub_w(v_h, uv);
