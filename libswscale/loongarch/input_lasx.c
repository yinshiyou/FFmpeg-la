                           ...
                           int width, int32_t *rgb2yuv)
{
    ...
    for (i = 0; i < len; i += 16) {
        ...
        LASX_DUP2_ARG3(__lasx_xvshuf_b, u_h, u_l, mask, v_h, v_l, mask, u_lh, v_lh);
    ...
    if (width - i >= 8) {
        ...
        u_l = __lasx_xvsra_w(u_l, sra);
        v_l = __lasx_xvsra_w(v_l, sra);
        LASX_DUP2_ARG3(__lasx_xvshuf_b, u_l, u_l, mask, v_l, v_l, mask, u, v);
